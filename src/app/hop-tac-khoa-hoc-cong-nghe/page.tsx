/**
 * Science & Technology Cooperation Page
 * Displays paginated grid of news articles from the "Hợp tác khoa học công nghệ" category
 */
...
const ScienceTechCooperationPagination = dynamic(() => import('./components/ScienceTechCooperationPagination'), {
  loading: () => (
...
const CATEGORY_SLUG = 'hop-tac-khoa-hoc-cong-nghe';

// Page props interface
interface ScienceTechCooperationPageProps {
...
export const metadata: Metadata = {
  title: `Hợp tác khoa học công nghệ - ${SITE_NAME}`,
  description:
    'Các hoạt động hợp tác nghiên cứu khoa học, chuyển giao công nghệ và phát triển đổi mới sáng tạo',
  alternates: { canonical: `${SITE_URL}/hop-tac-khoa-hoc-cong-nghe` },
  openGraph: {
    title: `Hợp tác khoa học công nghệ - ${SITE_NAME}`,
    description:
      'Các hoạt động hợp tác nghiên cứu khoa học, chuyển giao công nghệ và phát triển đổi mới sáng tạo',
    url: `${SITE_URL}/hop-tac-khoa-hoc-cong-nghe`,
    type: 'website',
    locale: 'vi_VN',
  ...
  twitter: {
    ...
    title: `Hợp tác khoa học công nghệ - ${SITE_NAME}`,
    description: 'Các hoạt động hợp tác nghiên cứu khoa học, chuyển giao công nghệ và phát triển đổi mới sáng tạo',
    images: [`${SITE_URL}/images/logo.png`],
  },
};

// Data fetching function
async function getScienceTechCooperationArticles(params: {
  page?: number;
  sort?: string;
  ...
  try {
    ...
    if (!response.ok) {
      throw new Error('Failed to fetch science & tech cooperation articles');
    }
    ...
    return {
      ...
      categoryName: data?.data?.category?.name || 'Hợp tác khoa học công nghệ'
    };
  } catch (error) {
    console.error('Error fetching science & tech cooperation articles:', error);
    return {
      articles: [],
      total: 0,
      totalPages: 1,
      categoryName: 'Hợp tác khoa học công nghệ'
    };
  }
}
...
const structuredData = [
  {
    ...
    '@type': 'CollectionPage',
    name: `Hợp tác khoa học công nghệ - ${SITE_NAME}`,
    description: 'Các hoạt động hợp tác nghiên cứu khoa học, chuyển giao công nghệ và phát triển đổi mới sáng tạo',
    url: `${SITE_URL}/hop-tac-khoa-hoc-cong-nghe`,
    isPartOf: {
      '@type': 'WebSite',
...
export default async function ScienceTechCooperationPage({ searchParams }: ScienceTechCooperationPageProps) {
  const params = await searchParams;
  const currentPage = parseInt(params.page || '1');
  const sort = params.sort || 'newest';

  // Fetch science & tech cooperation articles
  const { articles, total, totalPages, categoryName } = await getScienceTechCooperationArticles({
    page: currentPage,
    sort
  });
  ...
  const breadcrumbItems = [
    ...
    { label: 'Hợp tác khoa học công nghệ', href: '/hop-tac-khoa-hoc-cong-nghe', current: true }
  ];
          ...
          <div className="w-full max-w-[92%] mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {totalPages > 1 && (
              <Suspense fallback={
                ...
                <ScienceTechCooperationPagination
                  currentPage={currentPage}
                  totalPages={totalPages}
                  sort={sort}
                />
