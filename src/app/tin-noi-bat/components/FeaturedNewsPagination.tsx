/**
 * Featured News Pagination Component
 * Pagination controls for featured news page
 */
...
interface FeaturedNewsPaginationProps {
  currentPage: number;
  totalPages: number;
  sort?: string;
}

const FeaturedNewsPagination: React.FC<FeaturedNewsPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/tin-noi-bat${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default FeaturedNewsPagination;
