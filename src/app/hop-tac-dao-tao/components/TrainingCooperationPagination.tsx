/**
 * Training Cooperation Pagination Component
 * Pagination controls for training cooperation page
 */
...
interface TrainingCooperationPaginationProps {
  currentPage: number;
  totalPages: number;
  sort?: string;
}

const TrainingCooperationPagination: React.FC<TrainingCooperationPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/hop-tac-dao-tao${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default TrainingCooperationPagination;
