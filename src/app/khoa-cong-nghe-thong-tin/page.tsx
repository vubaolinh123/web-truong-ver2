...
const ITFacultyArticle = dynamic(() => import('./components/ITFacultyArticle'), {
...
export const metadata: Metadata = {
  title: `Khoa Công nghệ thông tin - ${SITE_NAME}`,
  description:
    'Tìm hiểu về Khoa Công nghệ thông tin, chương trình đào tạo và hoạt động nghiên cứu của Trường Cao đẳng Thông tin và Truyền thông.',
  alternates: {
    canonical: `${SITE_URL}/khoa-cong-nghe-thong-tin`,
  },
  openGraph: {
    title: `Khoa Công nghệ thông tin - ${SITE_NAME}`,
    description:
      'Khoa Công nghệ thông tin - Đào tạo và nghiên cứu trong lĩnh vực CNTT tại Trường Cao đẳng Thông tin và Truyền thông.',
    url: `${SITE_URL}/khoa-cong-nghe-thong-tin`,
    type: 'website',
    locale: 'vi_VN',
    images: [
  ...
  twitter: {
    ...
    title: `Khoa Công nghệ thông tin - ${SITE_NAME}`,
    description: 'Khoa Công nghệ thông tin - Đào tạo và nghiên cứu trong lĩnh vực CNTT.',
    images: [`${SITE_URL}/images/logo.png`],
  },
};

// Structured data (Organization + EducationalOrganization)
const itFacultyJsonLd = [
  {
    ...
    description:
      'Khoa Công nghệ thông tin - Đơn vị đào tạo và nghiên cứu chuyên sâu trong lĩnh vực Công nghệ Thông tin.',
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Organization',
    ...
    foundingDate: '2010-01-01',
    description:
      'Khoa Công nghệ thông tin chịu trách nhiệm đào tạo nguồn nhân lực chất lượng cao trong lĩnh vực CNTT.',
  }
];
...
export default function ITFacultyPage() {
  return (
    <Layout>
      ...
      <Seo minimal jsonLd={itFacultyJsonLd as any} />
