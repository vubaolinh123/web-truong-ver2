/**
 * Other News Pagination Component
 * Pagination controls for other news page
 */
...
interface OtherNewsPaginationProps {
  currentPage: number;
  totalPages: number;
  sort?: string;
}

const OtherNewsPagination: React.FC<OtherNewsPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/tin-tuc-khac${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default OtherNewsPagination;
