/**
 * Training Plans Pagination Component
 * Pagination controls for training plans page
 */
...
interface TrainingPlansPaginationProps {
  currentPage: number;
  totalPages: number;
  sort?: string;
}

const TrainingPlansPagination: React.FC<TrainingPlansPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/ke-hoach-dao-tao${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default TrainingPlansPagination;
