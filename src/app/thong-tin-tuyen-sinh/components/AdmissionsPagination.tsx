/**
 * Admissions Pagination Component
 * Pagination controls for admissions information page
 */
...
const AdmissionsPagination: React.FC<AdmissionsPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/thong-tin-tuyen-sinh${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default AdmissionsPagination;
