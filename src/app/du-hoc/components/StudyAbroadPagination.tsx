/**
 * Study Abroad Pagination Component
 * Pagination controls for study abroad page
 */
...
interface StudyAbroadPaginationProps {
  currentPage: number;
  totalPages: number;
  sort?: string;
}

const StudyAbroadPagination: React.FC<StudyAbroadPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/du-hoc${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default StudyAbroadPagination;
