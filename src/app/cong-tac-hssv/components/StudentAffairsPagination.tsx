/**
 * Student Affairs Pagination Component
 * Pagination controls for student affairs page
 */
...
interface StudentAffairsPaginationProps {
  currentPage: number;
  totalPages: number;
  sort?: string;
}

const StudentAffairsPagination: React.FC<StudentAffairsPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/cong-tac-hssv${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default StudentAffairsPagination;
