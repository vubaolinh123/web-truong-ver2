/**
 * Training Programs Pagination Component
 * Pagination controls for training programs page
 */
...
interface TrainingProgramsPaginationProps {
  currentPage: number;
  totalPages: number;
  sort?: string;
}

const TrainingProgramsPagination: React.FC<TrainingProgramsPaginationProps> = ({
  currentPage,
  totalPages,
  sort = 'newest'
}) => {
  const buildPageUrl = (page: number) => {
    ...
    return `/chuong-trinh-dao-tao${params.toString() ? `?${params.toString()}` : ''}`;
  };
...
export default TrainingProgramsPagination;
