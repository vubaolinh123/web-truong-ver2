/**
 * Articles Error Page
 * Error boundary cho trang articles
 */
...
const ArticlesError: React.FC<ArticlesErrorProps> = ({ error, reset }) => {
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-md mx-auto p-6">
        ...
        <p className="text-gray-600 mb-6">
          Không thể tải trang quản lý bài viết. Vui lòng thử lại hoặc liên hệ quản trị viên.
        </p>
