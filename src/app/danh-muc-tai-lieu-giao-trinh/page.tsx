...
const DocumentCatalogHero = dynamic(() => import('./components/DocumentCatalogHero'), {
  loading: () => <div className="h-72 md:h-96 bg-gradient-to-r from-blue-900 to-blue-700 animate-pulse" />,
});
const DocumentCatalogArticle = dynamic(() => import('./components/DocumentCatalogArticle'), {
...
export const metadata: Metadata = {
  title: `Danh mục tài liệu, giáo trình - ${SITE_NAME}`,
  description:
    'Danh mục tài liệu, giáo trình phục vụ giảng dạy và học tập tại Trường Cao đẳng Thông tin và Truyền thông.',
  alternates: {
    canonical: `${SITE_URL}/danh-muc-tai-lieu-giao-trinh`,
  },
  openGraph: {
    title: `Danh mục tài liệu, giáo trình - ${SITE_NAME}`,
    description:
      'Danh mục tài liệu, giáo trình phục vụ giảng dạy và học tập tại Trường Cao đẳng Thông tin và Truyền thông.',
    url: `${SITE_URL}/danh-muc-tai-lieu-giao-trinh`,
    type: 'website',
    locale: 'vi_VN',
    images: [
  ...
  twitter: {
    ...
    title: `Danh mục tài liệu, giáo trình - ${SITE_NAME}`,
    description: 'Danh mục tài liệu, giáo trình phục vụ giảng dạy và học tập của nhà trường.',
    images: [`${SITE_URL}/images/logo.png`],
  },
};

// Structured data
const documentCatalogJsonLd = [
  {
  ...
  },
  {
    ...
    foundingDate: '2010-01-01',
    description:
      'Thông tin về danh mục tài liệu, giáo trình tại Trường Cao đẳng Thông tin và Truyền thông.',
  }
];
...
export default function DocumentCatalogPage() {
  return (
    <Layout>
      ...
      <Seo minimal jsonLd={documentCatalogJsonLd as any} />

      {/* Page container */}
      <div className="min-h-screen bg-white">
        <DocumentCatalogHero />
        <DocumentCatalogArticle />
      </div>
    </Layout>
  );
}
